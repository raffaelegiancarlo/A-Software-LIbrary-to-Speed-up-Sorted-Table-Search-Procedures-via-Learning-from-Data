...
## Genaral 
This directory contains two cpp files. files. The first (NOME FILE) implements branch-free binary search. The secomd (NOME FILE) Eytzeinger Layout Binary Search. Bothy programs are stand-alone. 
