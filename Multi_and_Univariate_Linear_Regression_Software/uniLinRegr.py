...
parser.add_argument('-o', '--output', dest="outputFile", default="univariate_linear_regression.json",
...
with open(os.path.join(args.outputDir, "ulr_w_"+args.inputFile+".dat"),'w') as f:
    for weight in w:
        print(weight[0])
